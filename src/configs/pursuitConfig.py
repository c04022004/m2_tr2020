...
POINT_1 = (5.71+0.05, 3.09+0.5*0.03+0*1.3)
POINT_2 = (5.71+0.05, 3.09+1.0*0.03+1*1.3)
POINT_3 = (5.71+0.05, 3.09+2.0*0.03+2*1.3)
POINT_4 = (5.71+0.05, 3.09+3.0*0.03+3*1.3)
POINT_5 = (5.71+0.05, 3.09+4.0*0.03+4*1.3)
