...
CHK_PTS = [
    ...
    # scene 2
    {
        ...
        'f_path': [ POINT_A,(3.55408,3.57824),POINT_2 ],
...
try1_param = [  {'hook_func' : [{'hook0':None}],
                ...
                {'hook_func' : [{'comm_pr_can_lift':[CAN_CLIP_PT_A]}],
                 'cfg_name'  : 'scene1_b',
                 'cfg_param' : {'speed':MAX_SPEED*1.0, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':8.0, 'curvature_penalty_kP':1.0, 'accel_lim':1.8},
