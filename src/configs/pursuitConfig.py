...
try0_param = [  {'hook_func' : [{'call_pr':[START_COMMAND]}],
                ...
                {'hook_func' : [{'ball_guard':None}],
                 ...
                 'cfg_param' : {'speed':MAX_SPEED*1.0, 'radius':2.5, 'stop_min_speed':0.75,
                                'velocity_shift_kP':1.0, 'curvature_penalty_kP':0.0, 'accel_lim':5.5},
                 'trig_name' : 'mode_trig',
                 'log_msg'   : "start running for receiving pos",},
                {'hook_func' : [{'ball_guard':None}],
                 'cfg_name'  : 'scene0_fs',
                 'cfg_param' : {'speed':MAX_SPEED*0.5, 'kP':3.0, 'kI':0.0001, 'kD':2.5, 'accel_lim':3.5},
...
try1_param = [  {'hook_func' : [{'hook0':None}],
                 ...
                 'cfg_param' : {'speed':MAX_SPEED*1.0, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':6.0, 'curvature_penalty_kP':0.4, 'accel_lim':3.0},
                 'trig_name' : 'try_pid_trig',
                 'log_msg'   : "start running for Try Spot 1",},
                {'hook_func' : [{'hook1':None}],
                 'cfg_name'  : 'scene1_li',
                 'cfg_param' : {'speed':min(MAX_SPEED*0.65,2.0), 'kP':2.0, 'kI':0.0001, 'kD':3.0, 'accel_lim':3.5},
                 'trig_name' : 'mode_trig',
                ...
                {'hook_func' : [{'comm_pr_can_lift':[CAN_CLIP_PT_E]}],
                 'cfg_name'  : 'scene1_b',
                 'cfg_param' : {'speed':MAX_SPEED*1.0, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':8.0, 'curvature_penalty_kP':0.4, 'accel_lim':3.0},
                ...
                {'hook_func' : [{'post_try_seq':None},{'call_pr':[CAN_PASS_COMMAND]}],
                 ...
                 'cfg_param' : {'speed':MAX_SPEED*0.5, 'kP':2.0, 'kI':0.0001, 'kD':4.0, 'accel_lim':3.5},
...
try2_param = [  {'hook_func' : [{'hook0':None}],
                 'cfg_name'  : 'scene2_f',
                 'cfg_param' : {'speed':MAX_SPEED*1.0, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':2.0, 'curvature_penalty_kP':0.4, 'accel_lim':3.0},
                 'trig_name' : 'try_pid_trig',
                ...
                {'hook_func' : [{'comm_pr_can_lift':[CAN_CLIP_PT_C]}],
                 'cfg_name'  : 'scene2_b',
                 'cfg_param' : {'speed':MAX_SPEED*1.0, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':6.0, 'curvature_penalty_kP':0.4, 'accel_lim':3.0},
                 'trig_name' : 'rec_pid_trig',
...
try3_param = [  {'hook_func' : [{'hook0':None}],
                 'cfg_name'  : 'scene3_f',
                 'cfg_param' : {'speed':MAX_SPEED*1.0, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':2.0, 'curvature_penalty_kP':0.1, 'accel_lim':4.0},
                 'trig_name' : 'try_pid_trig',
                 'log_msg'   : "start running for Try Spot 3",},
                {'hook_func' : [{'hook1':None}],
                 'cfg_name'  : 'scene3_li',
                 'cfg_param' : {'speed':min(MAX_SPEED*0.65,2.0), 'kP':2.0, 'kI':0.001, 'kD':3.0, 'accel_lim':3.5},
                 'trig_name' : 'mode_trig',
                 'log_msg'   : "Triggering lidar detection",},
                {'hook_func' : [{'do_lidar':None}],
                 'cfg_name'  : 'scene3_fs',
                ...
                {'hook_func' : [{'comm_pr_can_lift':[CAN_CLIP_PT_B]}],
                 'cfg_name'  : 'scene3_b',
                 'cfg_param' : {'speed':MAX_SPEED*1.0, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':6.0, 'curvature_penalty_kP':0.1, 'accel_lim':4.0},
                 'trig_name' : 'rec_pid_trig',
                 'log_msg'   : "back to receiving pos",},
                {'hook_func' : [{'post_try_seq':None},{'call_pr':[CAN_PASS_COMMAND]}],
                 'cfg_name'  : 'scene3_bs',
...
try4_param = [  {'hook_func' : [{'hook0':None}],
                ...
                {'hook_func' : [{'comm_pr_can_lift':[CAN_CLIP_PT_D]}],
                 ...
                 'cfg_param' : {'speed':MAX_SPEED*0.9, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':8.0, 'curvature_penalty_kP':0.6, 'accel_lim':3.0},
                 'trig_name' : 'rec_pid_trig',
                 'log_msg'   : "back to receiving pos",},
                {'hook_func' : [{'post_try_seq':None},{'call_pr':[CAN_PASS_COMMAND]}],
                 'cfg_name'  : 'scene4_bs',
...
try5_param = [  {'hook_func' : [{'hook0':None}],
                 ...
                 'cfg_param' : {'speed':MAX_SPEED*0.8, 'radius':2.0, 'stop_min_speed':0.75,
                                'velocity_shift_kP':2.0, 'curvature_penalty_kP':0.8, 'accel_lim':3.0},
                 'trig_name' : 'try_pid_trig',
...
try9_param = [  {'hook_func' : None,
                 'cfg_name'  : None,
                 'log_msg'   : "start running for recA",},
                {'hook_func' : None,
                 'cfg_name'  : 'scene0_fs',
                 'cfg_param' : {'speed':MAX_SPEED*0.5, 'kP':3.0, 'kI':0.0001, 'kD':2.5},
                 'trig_name' : "default_trig",
                 'log_msg'   : "breaking stage before recA",},
                None, None, None, None,
                {'hook_func' : [{'ball_guard':None}],
                 'cfg_name'  : None,
                 'log_msg'   : None,}  ]
...
try12_param = [ {'hook_func' : None,
                 'cfg_name'  : None,
                 'log_msg'   : "start running for recB",},
                {'hook_func' : None,
                 'cfg_name'  : 'scene3_bs',
                 'cfg_param' : {'speed':MAX_SPEED*0.5, 'kP':3.0, 'kI':0.0001, 'kD':2.5},
                 'trig_name' : "default_trig",
                 'log_msg'   : "breaking stage before recB",},
                None, None, None, None,
                {'hook_func' : [{'ball_guard':None}],
                 'cfg_name'  : None,
                 'log_msg'   : None,}  ]
...
try11_param = [ {'hook_func' : None,
                 'cfg_name'  : None,
                 'log_msg'   : "start running for recC",},
                {'hook_func' : None,
                 'cfg_name'  : 'scene2_bs',
                 'cfg_param' : {'speed':MAX_SPEED*0.5, 'kP':3.0, 'kI':0.0001, 'kD':2.5},
                 'trig_name' : "default_trig",
                 'log_msg'   : "breaking stage before recC",},
                None, None, None, None,
                {'hook_func' : [{'ball_guard':None}],
                 'cfg_name'  : None,
                 'log_msg'   : None,}  ]
...
try14_param = [ {'hook_func' : None,
                 'cfg_name'  : None,
                 'log_msg'   : "start running for recE",},
                {'hook_func' : None,
                 'cfg_name'  : 'scene1_bs',
                 'cfg_param' : {'speed':MAX_SPEED*0.5, 'kP':3.0, 'kI':0.0001, 'kD':2.5},
                 'trig_name' : "default_trig",
                 'log_msg'   : "breaking stage before recE",},
                None, None, None, None,
                {'hook_func' : [{'ball_guard':None}],
                 'cfg_name'  : None,
                 'log_msg'   : None,}  ]
...
try15_param = [ {'hook_func' : None,
                 'cfg_name'  : None,
                 'log_msg'   : "start running for recD",},
                {'hook_func' : None,
                 'cfg_name'  : 'scene4_bs',
                 'cfg_param' : {'speed':MAX_SPEED*0.5, 'kP':3.0, 'kI':0.0001, 'kD':2.5},
                 'trig_name' : "default_trig",
                 'log_msg'   : "breaking stage before recD",},
                None, None, None, None,
                {'hook_func' : [{'ball_guard':None}],
                 'cfg_name'  : None,
                 'log_msg'   : None,}  ]